<header class="blog-header border-bottom shadow-sm bg-white">
    <div class="container-fluid" style="padding-left: 3rem; padding-right:3rem">
        ...
        <div class="d-flex flex-column flex-md-row align-items-center py-2">
            <a href="https://universemovers.co.ke/" class="my-0 mr-md-auto" style="width: 6rem;">
                <img src="img/logo/logo.svg" alt="dev culture logo" style="width: 80%;height: auto;">
            </a>
            ...
            <a class="btn btn-outline-primary" href="<?= ($loggedin) ? 'Logout.php' : 'login.php'; ?>">
