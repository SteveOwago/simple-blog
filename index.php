        ...
        <div class="jumbotron text-center p-0 mb-0">
            <div class="bg-div px-5 d-flex align-items-center">
                ...
                <div class="text-left w-50">
                    <h1 class="display-4 text-white">Welcome to Universe Movers Blog!</h1>
                    <h2 class="display-5 text-white">Discover, Be informed, and Learn on important information we offer absolutely free</h2>
                                ...
                                <div class="col-md-12">
                                    <div class="post post-row">
                                        ...
                                        <div class="post-body">
                                            ...
                                            <h3 class="post-title"><a href="single_article.php?id=<?= $article['article_id'] ?>"><?= $article['article_title'] ?></a></h3>
                                            <p><?= substr($article['article_content'], 0, 200);?>... <a href="single_article.php?id=<?= $article['article_id']?>" class="btn btn-sm btn-primary">Read More</a></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- /post -->
